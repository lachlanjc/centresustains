import { Text, Flex, Button, Grid } from 'theme-ui'
...
## We’re holding an open forum on Zoom for community members to help inform our climate planning & strategies.

<Flex as="section" sx={{ alignItems: 'center', flexWrap: 'wrap', mb: [3, 4, 5] }}>
<Cal month="April" day={13} />
...
<NavCard color="green" icon={ClipboardData} to="/survey">
  Take the survey
</NavCard>
