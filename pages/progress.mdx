...
---
export default props => <Story cards color="pink" {...props} />

# <BookmarkStar /> Resources

## If you’re looking to lessen the carbon footprint of your lifestyle, we’ve gathered these resources to help, alongside some relevant books & local journalism.
