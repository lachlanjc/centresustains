...
<Meta
  ...
  description="If you’re looking to reduce the carbon footprint of your lifestyle in central Pennsylvania, we’ve gathered these resources to help."
  image="https://centresustains.com/cards/resources.jpg"
/>
...
- [<Image src="/progress/drawdown.jpg" width={545} height={698} placeholder="blur" alt="Drawdown book cover" />](https://www.penguinrandomhouse.com/books/549348/drawdown-by-edited-by-paul-hawken/)
- [<Image src="/progress/all_we_can_save.jpg" width={470} height={717} placeholder="blur" alt="All We Can Save book cover" />](https://www.allwecansave.earth/)
