...
## If you’re looking to lessen the carbon footprint of your lifestyle, we’ve gathered these resources to help.
...
<NavCard to="/climate" color="azure" icon={BlockquoteLeft}>
